...
import pygame #create music...
from pygame import mixer #package from pygame
from PIL import Image #Pillow proccessing image
import pytesseract # Google OCR 
import os # operate system
import glob # Global
import PySimpleGUI as sg #graphic user interface
import tkinter as tk # package supported GUI
import fitz 
...
def main():
    ...
    final_directory = os.path.join(
        current_directory, r'Result-Audiobook')
...
#***************************************************************************#
    ...
    for file in os.listdir(final_directory):
        data = pytesseract.image_to_string(Image.open(
            os.path.join(final_directory, file)), lang="vie")
...
#************************************************************************************************************************************#
    ...
    # have a high speed
    myobj = gTTS(text=newtext, lang='vi', slow=False)
