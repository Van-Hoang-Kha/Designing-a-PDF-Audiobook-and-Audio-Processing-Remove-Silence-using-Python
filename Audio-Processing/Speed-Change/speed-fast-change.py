...
def speed_change(sound, speed):
    ...
    filename = r'/home/kha/Documents/text-to-speech/Result-Audiobook/Change-fast-pdf.mp3'
...
playaudio = AudioSegment.from_file(
    r"/home/kha/Documents/text-to-speech/Result-Audiobook/Change-fast-pdf.mp3", format="mp3")
play(playaudio)
